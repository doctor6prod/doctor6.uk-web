  ...
  <div class="padding text-contrast">
    ...
    <section>
      ...
      <section>
        ...
        <p>
          After completing Sound Technician studies and DJ courses (Vinyl & CDJ), he shifted his focus from 
          beatmaking to the art of mixing. A pivotal mentorship with a Gardel Award-winning engineer marked the beginning 
          of his path as a dedicated mixer.
        </p>
      </section>
...
p {
  @apply ml-4 mt-4 leading-relaxed;
}
