<template>
  <a
    ...
    @click.stop 
  >
    <!-- El @click.stop frena el evento acá y evita que el router de la Home lo intercepte -->
    ...
    <i-fluency-tank v-if="link.includes('newgrounds')" class="w-5 h-5" />
    <i-fluency-cloud v-if="link.includes('soundcloud')" class="w-5 h-5" />
